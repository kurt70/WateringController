...
- Treat `.squad/` under the repo root as shared, versioned repository state; keep only machine-local artifacts in ignored files.

## Repo Structure
- `src/backend/` – ASP.NET Core backend
- `src/frontend/` – Web UI
- `infra/firmware/pump-esp32/`
- `infra/firmware/level-esp32/`
